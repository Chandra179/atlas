...
For general vLLM concepts (continuous batching, prefix caching, speculative decoding, KV cache mechanics), see [LLM deployment infrastructure](llm/llm-deployment.md).
...
### Further Reading
- [`llm-deployment.md`](llm/llm-deployment.md) general vLLM concepts (batching, caching, decoding, observability).
