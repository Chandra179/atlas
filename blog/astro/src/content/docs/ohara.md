...
title: Ohara
description: >-
  A Rust-based document data pipeline that scrapes, cleans, vectorizes, and
  indexes content for retrieval and graph-based knowledge discovery.
seoTitle: 'Ohara: Rust Data Pipeline for Scraping, Vectors & Graphs'
seoDescription: >-
  Ohara is a Rust document pipeline for scraping sources, cleaning content,
  generating vectors, and building retrieval and relationship graphs.
answerSummary: >-
  Ohara is a Rust-based document data pipeline: it scrapes sources, cleans and
  chunks content, generates vectors, and combines keyword, semantic, and graph
  retrieval for citation-ready search.
tags:
  - system-design
  - llm
  - rag
