...
$$\text{Unemployment Rate (U3)} = \frac{\text{Unemployed}}{\text{Labor Force}} \times 100$$
...
$$\text{Percentage change in unemployment} = -\frac{1}{2} (\text{Percentage change in real GDP} - \text{Normal growth rate})$$
