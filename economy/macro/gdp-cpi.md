...
- **Expenditure approach**: $$GDP = C + I + G + NX$$ (consumption + investment + government purchases + net exports)
...
$$GNP = GDP + \text{Net factor payments from abroad}$$
...
- **GDP deflator**: $$\text{GDP Deflator} = \frac{\text{Nominal GDP}}{\text{Real GDP}} \times 100$$ a broad measure of the price level
