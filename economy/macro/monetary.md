...
$$i = r^* + \pi + \alpha(\pi - \pi^*) + \beta(y - \bar{y})$$
...
1. Fed sets the federal funds rate target
2. Changes in the fed funds rate transmit to short-term market rates
3. Short-term rates influence long-term rates (bonds, mortgages) via expectations
4. Changes in borrowing costs affect consumption, investment, and net exports
5. Changes in aggregate spending affect output and inflation
