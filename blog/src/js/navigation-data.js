    ...
    },
    {
        ...
        pages: [
            ...
            },
            {
                ...
                isFolder: true,
                pages: [
                    { name: "Capital Flows", slug: "capital-flows" },
                    { name: "Climate Finance", slug: "climate-finance" },
                    { name: "Digital Currency", slug: "digital-currency" },
                    { name: "Dollar System", slug: "dollar-system" },
                    { name: "Energy Geopolitics", slug: "energy-geopolitics" },
                    { name: "Exchange Rates", slug: "exchange-rates" },
                    { name: "Export Controls", slug: "export-controls" },
                    { name: "Financial Crises", slug: "financial-crises" },
                    { name: "Shadow Banking", slug: "shadow-banking" },
                    { name: "Sovereign Debt", slug: "sovereign-debt" },
            ...
            },
            {
                ...
                isFolder: true,
                pages: [
                    { name: "Ad As", slug: "ad-as" },
                    { name: "Gdp Cpi", slug: "gdp-cpi" },
                    { name: "Growth Finance", slug: "growth-finance" },
                    { name: "Monetary", slug: "monetary" },
                    { name: "Open Economy", slug: "open-economy" },
                    { name: "Phillips Curve", slug: "phillips-curve" },
                    { name: "Solow Growth", slug: "solow-growth" },
            ...
            },
            {
                ...
                isFolder: true,
                pages: [
                    { name: "Externalities", slug: "externalities" },
                    { name: "Frontiers", slug: "frontiers" },
                    { name: "Game Theory", slug: "game-theory" },
                    { name: "Labor Markets", slug: "labor-markets" },
                    { name: "Market Intervention", slug: "market-intervention" },
                    { name: "Market Structures", slug: "market-structures" },
                    { name: "Production", slug: "production" },
                    { name: "Supply Demand", slug: "supply-demand" },
                    { name: "Welfare Efficiency", slug: "welfare-efficiency" },
                ],
            },
        ],
    },
