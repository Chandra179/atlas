...
How it works: the Worker fetches the static page HTML via `env.ASSETS`, strips the navigation and breadcrumbs with `linkedom`, then passes the cleaned HTML to Browser Run for PDF rendering.
