...
```mermaid
flowchart LR
    G["Georgia (2003)"] --> R1["Purged corrupt police & modernized institutions (P2, P10)"]
    V["Venezuela (2000s)"] --> R2["Colectivos, media blockages, and state decay (P6, P7, P12)"]
    SA["South Africa (2016)"] --> R3["Zuma-Gupta state capture & judicial exposure (P4, P11)"]
    E["Egypt (2011)"] --> R4["Police vs. Military rivalry & Baltagiyya gangs (P10, P12)"]
    P["Philippines (1986)"] --> R5["Crony cartels, media monopoly, dynastic rewrites (P4, P11, P13)"]
    ES["Estonia (1990s)"] --> R6["Eliminated bureaucratic corruption via e-Gov (P3, P4, P7)"]
    H["Haiti (1950s-70s)"] --> R7["Tonton Macoutes, dogma, deliberate illiteracy (P8, P9, P12)"]
```
